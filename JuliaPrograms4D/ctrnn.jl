...
function vector_field!(du, u, p, t)
    ws, wi, we, delta, epsilon = p
    du[1] = -u[1] + ws * sigmoid(u[1], delta, epsilon) + wi * sigmoid(u[2], delta, epsilon) + we/2 * sigmoid(u[3], delta, epsilon) + we/2 * sigmoid(u[4], delta, epsilon)

...
begin
	e_name = "Excitable Dynamics (GLV)"
	# #mu = 1
	# #a = 1.0
	# #b = 0.55
	# #c = 1.5
	n = 0.1
	e_params = (1.0, 1.0, 1.01, 2, n)
	e_ds = DS(3, vector_field!, jacobian!, noise_term!, x->x^2, e_params)

	h_name = "Heteroclinic Dynamics (GLV)"
	h_params = (1.0, 1.0, 0.6, 2, n)
	h_ds = DS(3, vector_field!, jacobian!, noise_term!, x->x^2, h_params)
...
plot_time_series(h_ds, initial_conditions, tspan, h_name)

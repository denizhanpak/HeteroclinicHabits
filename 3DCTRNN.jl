...
# ╔═╡ 0b980276-1348-11f0-2236-7f097bcd5012
begin
	...
	include("/home/naxicon/Research/Metastability/Julia2Pause/HelpersFunctions.jl")
end

# ╔═╡ b663a8ed-dd1d-41f0-aa2a-d8396b1d1a52
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 2e6dd1c9-bec6-4449-93af-889d535854c9


# ╔═╡ da889b90-c6a8-4145-aa85-82097547753d
...
# ╔═╡ 4cf4e37e-77a9-4790-a455-18411b3fc94d
function sigmoid(x, delta, epsilon)
    return 1 / (1 + exp(-(x - delta) / epsilon))
end

# ╔═╡ 0c1e07c0-dc77-41e0-92aa-4b2252230bc4
...
# ╔═╡ eb1dac4b-12a7-408a-a12d-edd9bc00ee01
begin
	n = 0.1
	
	g_name = "Ghost Dynamics (CTRNN)"
	g_params = (1.0, -0.68, 0.23, 0.4, 0.05, n)
	g_ds = DS(3, vector_field!, jacobian!, noise_term!, x->x^2, g_params)
	
	e_name = "Excitable Dynamics (CTRNN)"
	# #mu = 1
	# #a = 1.0
	# #b = 0.55
	# #c = 1.5

	e_params = (1.0, -0.68, 0.19, 0.4, 0.05, n)
	e_ds = DS(3, vector_field!, jacobian!, noise_term!, x->x^2, e_params)
...
# ╔═╡ 13d5fe10-085a-4831-b7fc-b1970b544ced
plot_time_series(g_ds, initial_conditions, tspan, g_name)

# ╔═╡ 71d2235c-fd3e-46cf-84d1-08cc3b59478b
plot_time_series(e_ds, initial_conditions, tspan, e_name)
...
manifest_format = "2.0"
project_hash = "57f3dee5784adfd440cee32e955f0812b37da5e4"
